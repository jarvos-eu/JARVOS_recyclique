...
| **2026-05-21_validation-comptes-liaison-paheko_perplexity_prompt.md** | **2e passe** Perplexity — prompt **autonome** (contexte + 1re recherche + plan Paheko/Recyclique + 11 questions dans le bloc copier-coller). Réponse → `…_reponse.md`. |
