...
| **2026-05-21_validation-comptes-liaison-paheko_perplexity_reponse.md** | **Réponse** 2e passe — tableau 11 questions, plan comptable cible. Ventilée → [guide](../migration-paheko/2026-05-21_guide-liaison-paheko-compta.md), `decisions`, `repertoire-comptes`. |
| **2026-05-21_liaison-paheko-trous-recherche_perplexity_prompt.md** | **3e passe** Perplexity — trous R1–R8. Réponse → `…_reponse.md`. |
| **2026-05-21_liaison-paheko-trous-recherche_perplexity_reponse.md** | **Réponse** 3e passe — T1/T2/T3, synchro off, seuil 2 €. Ventilée → [guide](../migration-paheko/2026-05-21_guide-liaison-paheko-compta.md), `procedure-cloture`, `decisions` D29–D38. |
