...
- **`eco-organismes/`** — Matière **module décla** : référentiels partenaires (eco-maison, Ecologic, Refashion…), **déclarations déjà remplies** par La Clique (Excel/PDF par trimestre), source mapping → patch **1.4.5**. Ventilé depuis K-Drive le 2026-07-07. Détail : **eco-organismes/index.md** · inventaire : [artefacts/2026-07-07_01_inventaire-depot-eco-organismes-la-clique.md](artefacts/2026-07-07_01_inventaire-depot-eco-organismes-la-clique.md).
  _(Charger : mapping catégories eco-maison, patch stats/décla La Clique, Epic 9, préparation trimestrielle.)_

- **`migration-paheko/`** — Guides Paheko/RecyClique, TODO, comptes-rendus, décla éco-organismes (générique), specs d'intégration tiers (ex. HelloAsso). Croiser avec **eco-organismes/** (terrain La Clique) et **consolidation-1.4.5/** pour le code. Détail : **migration-paheko/index.md**. **PRD caisse / compta / Paheko (v1.0, 2026-04-15)** : [migration-paheko/2026-04-15_prd-recyclique-caisse-compta-paheko.md](migration-paheko/2026-04-15_prd-recyclique-caisse-compta-paheko.md).
  _(Charger : intégration Paheko, filières REP génériques, historique décisions, cadrage HelloAsso / paiements en ligne.)_
