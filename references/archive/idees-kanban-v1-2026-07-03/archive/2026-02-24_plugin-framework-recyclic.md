...
## 2026-07-03 — Intégrée — design système modules (artefact 07)

**Passage à `archive`.** Couvert par [`2026-02-24_07_design-systeme-modules.md`](../../artefacts/2026-02-24_07_design-systeme-modules.md) : manifeste TOML, `ModuleBase`, Redis Streams, activation par instance ; intégré dans architecture et stories modulaires v2.
