...
| `2026-05-21_decisions-compta-liaison-paheko-recherche-terrain.md` | **Décisions produit figées** (Perplexity 1re + 2e passe + terrain) : 7070/7541/530/5112/511/658-758, 2 pièces clôture, param SuperAdmin ; rejets ; questions EC ; lien prompt 3e passe. |
| `2026-05-21_repertoire-comptes-terrain-audio-recyclique.md` | **Répertoire comptes** — statuts mis à jour après validation 2e passe ; workflow 2 pièces ; checklist EC. |
