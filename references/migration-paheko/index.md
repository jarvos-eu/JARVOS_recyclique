...
| `2026-05-21_guide-liaison-paheko-compta.md` | **Entrée unique** liaison caisse → Paheko (lecture rapide, liens canoniques, exemple clôture). _(Charger en premier pour session compta / brainstorm fermeture.)_ |
| `2026-05-21_courrier-validation-compta-paheko-corinne-caro.md` | **Courrier validation** pour Corinne (comptable) et Caro — récap terrain + 3 passes, workflow, plan comptable, cases à cocher. |
| `2026-05-21_decisions-compta-liaison-paheko-recherche-terrain.md` | **Décisions produit figées** (Perplexity 1re + 2e + **3e passe**) : D1–D38, T1/T2/T3, synchro Paheko off, seuil ±2 € ; rejets (709, 678/778) ; questions EC. |
| `2026-05-21_procedure-cloture-liaison-paheko-recyclique.md` | **Procédure opérationnelle** clôture → Paheko (T1/T2/T3, comptage, chèques/CB, checklist prod). |
| `2026-05-21_repertoire-comptes-terrain-audio-recyclique.md` | **Répertoire comptes** — 2e + 3e passe ; workflow T1/T2/T3 ; checklist EC. |
| `2026-05-21_multi-caisse-lieux-vente-paheko-recyclique.md` | **Multi-caisse** — 1 caisse = 1 compte 53x ; Lieux de vente Paheko ↔ `cash_registers` ; grille 7 caisses ; 58 ; impacts RecyClique (param par poste, comptage). _(Charger si plusieurs sites/postes.)_ |
