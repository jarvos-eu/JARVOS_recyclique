...
| Erreur de caisse | Écart solde physique / théorique à la clôture | Case « Je confirme avoir re-compté… » | Natif Paheko : 678/778. **RecyClique** : **658/758** (T3), seuil ±2 € ; **désactiver synchro auto** extension si API RecyClique ([décisions 2026-05-21](../2026-05-21_decisions-compta-liaison-paheko-recherche-terrain.md) D30) | `POS::ERROR_DEBIT_ACCOUNT`, `POS::ERROR_CREDIT_ACCOUNT`, `Sessions::listClosingBalances` |
