...
| `2026-05-22_vision-flux-objets-reception-etiquettes-webcam-superadmin.md` | **Vision fixée** (langage métier) : identité objet par code-barres/QR, chaîne réception → caisse, rôle bascule/webcam comme moyens, gouvernance super admin (étiquette tôt/tard, workflows par famille), liens recap terrain **2026-05-21_02** et PRD kiosques. |
